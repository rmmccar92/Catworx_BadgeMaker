        ...
        public static void MakeBadges(List<Employee> employees)
        {
            ...
            using (WebClient client = new WebClient())
            {
                for (int i = 0; i < employees.Count; i++)
                {
                    ...
                    graphic.DrawString(employees[i].GetName(), font, brush, new Rectangle(EMPLOYEE_NAME_START_X, EMPLOYEE_NAME_START_Y, EMPLOYEE_NAME_WIDTH, EMPLOYEE_NAME_HEIGHT), format);
                    ...
                    badge.Save("data/employeeBadge" + employees[i].GetId() + ".png");
                }
            }
